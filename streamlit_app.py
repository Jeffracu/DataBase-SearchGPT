...
texto_ad1 = "Actúa como buscador del dataframe df_db. Lista completamente (sin abreviar) todos los proyectos usando id_archivo, url y carpeta de ubicación, si cumple con las condiciones exactas en el dataframe a la siguiente consulta de usuario :"
texto_ad2 = ". Si no hay coincidencias exactas referencia proyectos usando id_archivo, url y carpeta de ubicación, con alguna condición similar a la consulta de usuario en el dataframe. Responde siempre en español y referencia siempre con una lista por id_archivo, url y carpeta de ubicación, Complementa con detalles estructurales de cada estructura de referencia, como tipo, altura, suelo, amenaza sismica"

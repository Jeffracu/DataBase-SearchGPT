...
texto_ad1 = "Actúa como buscador automatizado del dataframe df_db. Limitate a responder lo solicitado. Lista completamente (sin abreviar) todos los proyectos usando id_archivo, id_estructura y nombre, si cumple con las condiciones exactas en el dataframe a la siguiente consulta de usuario :"
texto_ad2 = ". Si no hay coincidencias exactas referencia proyectos usando id_archivo, id_estructura y nombre, con alguna condición similar a la consulta de usuario en el dataframe. Responde siempre en español y referencia siempre con una lista por id_archivo, id_estructura y nombre  y finaliza con el url de la carpeta de gestión documental https://drive.google.com/drive/u/2/folders/1Hd0ej0OHwkc7zAFFgwkQloeKRKCsvM2l "

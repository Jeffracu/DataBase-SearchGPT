...
texto_ad2 = ". Si no hay coincidencias exactas referencia proyectos usando id_archivo, url y carpeta de ubicación, con alguna condición similar a la consulta de usuario en el dataframe. Responde siempre en español y referencia siempre con una lista por id_archivo, url y carpeta de ubicación, Complementa con id estructura y nombre"

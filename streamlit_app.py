...
texto_ad1 = "Actúa como buscador del dataframe df_db. Lista todos los proyectos usando id_archivo, url y carpeta de ubicación, si cumple con las condiciones exactas en el dataframe a la siguiente consulta de usuario :"

...
texto_ad2 = ". Si no hay coincidencias exactas referencia proyectos usando id_archivo, id_estructura y nombre, con alguna condición similar a la consulta de usuario en el dataframe. Responde siempre en español y referencia siempre con una lista por id_archivo, id_estructura y nombre  y finaliza con el url de la carpeta de ubicación https://drive.google.com/drive/u/2/folders/1Hd0ej0OHwkc7zAFFgwkQloeKRKCsvM2l "
